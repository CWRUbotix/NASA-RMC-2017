...
# start the things
#cd glennifer/HCI
#nohup java -cp target/hci-1.0-SNAPSHOT.jar com.cwrubotix.glennifer.hci.ModuleMain &> "/home/ubuntu/logs/$datestring/ModuleMainOutput.log" &
#cd ..
...
cd autodrill
nohup java -cp target/autodrill-1.0-SNAPSHOT.jar com.cwrubotix.glennifer.autodrill.AutoDrillModule &> "/home/ubuntu/logs/$datestring/AutoDrillModuleOutput.log" &
cd ..
